...
<div class="mainbanner">
    <div id="main-banner" class="owl-carousel home-slider">
      ...
      <div class="item"> <a href="#"><img src="{{asset('image/banners/Main-Banner2.jpg')}}" alt="main-banner2" class="img-responsive" /></a> </div>
      <div class="item"> <a href="#"><img src="{{asset('image/banners/Main-Banner3.jpg')}}" alt="main-banner3" class="img-responsive" /></a> </div>
    </div>
</div>
    ...
    <div class="cms_banner">
      <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4">
              ...
              <a href="#"><img src="{{asset('image/banners/subbanner1.jpg')}}" alt="Sub Banner1" class="img-responsive"></a>
            ...
            <div class="col-xs-12 col-sm-4 col-md-4">
              <div class="banner sub-hover">
              <a href="#"><img src="{{asset('image/banners/subbanner2.jpg')}}" alt="Sub Banner2" class="img-responsive"></a>
              <div class="bannertext">
              <h2>furniture </h2>
              <p>Latest Designer</p>
              <button class="btn">Shop Now</button>
            ...
            <div class="col-xs-12 col-sm-4 col-md-4">
              <div class="banner sub-hover">
              <a href="#"><img src="{{asset('image/banners/subbanner3.jpg')}}" alt="Sub Banner3" class="img-responsive"></a>
              <div class="bannertext">
              <h2>HomeTown </h2>
